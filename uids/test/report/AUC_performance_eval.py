...
def clean_duplicates(s1):
    ...
    if len(s1[index]) != len(s1):
        log.severe("Duplicate items in embeddings s1! Removing {} duplicates...".format(len(s1)-len(s1[index])))
        s1 = s1[index]
...
if __name__ == '__main__':
    ...
    if False:
        params = {'T': [0.99]}
        clf = L2Estimator()
        tune_classifier(clf, params, avg_cycles=100, nr_training_samples=5, nr_test_samples=640, combine_scenes=False,
                        filename="L2Estimator_single-scene_train5_test640.csv")
        ...
        tune_classifier(clf, params, avg_cycles=100, nr_training_samples=5, nr_test_samples=640, combine_scenes=True,
                        filename="L2Estimator_multi-scene_train5_test640.csv")
    ...
    if False:
        ...
        clf = ABODEstimator()
        # tune_classifier(clf, params, avg_cycles=100, nr_training_samples=5, nr_test_samples=640, combine_scenes=False,
        #                 filename="ABODEstimator_single-scene_train5_test640.csv")
        # tune_classifier(clf, params, avg_cycles=100, nr_training_samples=10, nr_test_samples=640, combine_scenes=False,
        ...
        tune_classifier(clf, params, avg_cycles=100, nr_training_samples=5, nr_test_samples=640, combine_scenes=True,
                        filename="ABODEstimator_multi-scene_train5_test640.csv")
        tune_classifier(clf, params, avg_cycles=100, nr_training_samples=10, nr_test_samples=640, combine_scenes=True,
    ...
    if True:
        params = {'T': [0.12]}
        clf = ApproxABODEstimator()
        tune_classifier(clf, params, avg_cycles=100, nr_training_samples=5, nr_test_samples=640,
                        combine_scenes=False,
                        filename="ApproxABODEstimator_single-scene_train5_test640.csv")
        tune_classifier(clf, params, avg_cycles=100, nr_training_samples=10, nr_test_samples=640,
                        combine_scenes=False,
                        filename="ApproxABODEstimator_single-scene_train10_test640.csv")
        tune_classifier(clf, params, avg_cycles=100, nr_training_samples=20, nr_test_samples=640,
                        combine_scenes=False,
                        filename="ApproxABODEstimator_single-scene_train20_test640.csv")
        tune_classifier(clf, params, avg_cycles=100, nr_training_samples=40, nr_test_samples=640,
                        combine_scenes=False,
                        filename="ApproxABODEstimator_single-scene_train40_test640.csv")
